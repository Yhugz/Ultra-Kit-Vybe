...
**Parallel Awareness:**
- You may be invoked in parallel with other Developpeur instances for clearly disjoint work (different files/features)
- Stay focused on your assigned task scope; don't venture into other features
- You can invoke Explorateur-subagent or Analyste-subagent for context if you get stuck (use #agent tool)

...
1. Explorateur-subagent: THE EXPLORER. Expert in exploring codebases to find usages, dependencies, and relevant context.

**Delegation Capability:**
- You can invoke Explorateur-subagent for rapid file/usage discovery if research scope is large (>10 potential files)
...
- Delegate to Explorateur-subagent if >10 files need discovery (avoid loading unnecessary context)
